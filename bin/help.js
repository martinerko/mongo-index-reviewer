...
module.exports = function help() {
  ...
  console.log('');
  console.log('  Sample:\n')
  console.log('    ./bin/index localhost:27017/test --indexFile ./reviewedIndexes.js')
  console.log('    ./bin/index ds012345.myserver.com:56789/dbname --username dbuser --password dbpassword --indexFile ./reviewedIndexes.js')
};
